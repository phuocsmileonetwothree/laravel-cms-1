        ...
        <div class="p-5">
          <Preview>
            <div class="text-center">
              ...
              <a href="javascript:;" @click="smallModalSizePreview = true" class="btn btn-primary mr-1 mb-2">Show Small
                Modal</a>
              <!-- END: Small Modal Toggle -->
              <!-- BEGIN: Medium Modal Toggle -->
              <a href="javascript:;" @click="mediumModalSizePreview = true" class="btn btn-primary mr-1 mb-2">Show
                Medium Modal</a>
              <!-- END: Medium Modal Toggle -->
              <!-- BEGIN: Large Modal Toggle -->
              <a href="javascript:;" @click="largeModalSizePreview = true" class="btn btn-primary mr-1 mb-2">Show Large
                Modal</a>
              <!-- END: Large Modal Toggle -->
              <!-- BEGIN: Super Large Modal Toggle -->
              <a href="javascript:;" @click="superlargeModalSizePreview = true" class="btn btn-primary mr-1 mb-2">Show
                Superlarge Modal</a>
              <!-- END: Super Large Modal Toggle -->
            </div>
            <!-- BEGIN: Small Modal Content -->
            <Modal size="modal-sm" :show="smallModalSizePreview" @hidden="smallModalSizePreview = false">
              <ModalBody class="p-10 text-center">
            ...
            <Modal :show="mediumModalSizePreview" @hidden="mediumModalSizePreview = false">
              <ModalBody class="p-10 text-center">
            ...
            <Modal size="modal-lg" :show="largeModalSizePreview" @hidden="largeModalSizePreview = false">
              <ModalBody class="p-10 text-center">
            ...
            <Modal size="modal-xl" :show="superlargeModalSizePreview" @hidden="superlargeModalSizePreview = false">
              <ModalBody class="p-10 text-center">
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" class="btn btn-primary" @click="warningModalPreview = true">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="buttonModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
            <Modal :show="buttonModalPreview" @hidden="buttonModalPreview = false">
              <a @click="buttonModalPreview = false" class="absolute right-0 top-0 mt-3 mr-3" href="javascript:;">
              ...
              <ModalBody class="p-0">
                ...
                <div class="px-5 pb-8 text-center">
                  <button type="button" @click="buttonModalPreview = false" class="btn btn-primary w-24">
                    Ok
                  </button>
                </div>
              </ModalBody>
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="staticBackdropModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
            <Modal backdrop="static" :show="staticBackdropModalPreview" @hidden="staticBackdropModalPreview = false">
              <ModalBody class="px-5 py-10">
                <div class="text-center">
                  ...
                  <button type="button" @click="staticBackdropModalPreview = false" class="btn btn-primary w-24">
                    Ok
                  </button>
                </div>
              </ModalBody>
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="overlappingModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
            <Modal :show="overlappingModalPreview" @hidden="overlappingModalPreview = false">
              <ModalBody class="px-5 py-10">
                <div class="text-center">
                  <div class="mb-5">
                  ...
                  <a href="javascript:;" @click="nextOverlappingModalPreview = true" class="btn btn-primary">Show
                    Overlapping Modal</a>
                  <!-- END: Overlapping Modal Toggle -->
                </div>
                <!-- BEGIN: Overlapping Modal Content -->
                <Modal :show="nextOverlappingModalPreview" @hidden="nextOverlappingModalPreview = false">
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="headerFooterModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="deleteModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="successModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            <!-- BEGIN: Modal Toggle -->
            <div class="text-center">
              <a href="javascript:;" @click="tinySliderModalPreview = true" class="btn btn-primary">Show Modal</a>
            </div>
            <!-- END: Modal Toggle -->
            <!-- BEGIN: Modal Content -->
            <Modal :show="tinySliderModalPreview" @hidden="tinySliderModalPreview = false">
              <ModalBody>
                <div class="mx-6">
                  <TinySlider :options="{
        mouseDrag: true,
        ...
        responsive: {
          600: {
            items: 2,
                    ...
                    <div class="h-56 px-2">
                      <div class="h-full image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" :src="$f()[0].images[1]" />
                      </div>
                    </div>
                    <div class="h-56 px-2">
                      <div class="h-full image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" :src="$f()[0].images[2]" />
                      </div>
                    </div>
                    <div class="h-56 px-2">
                      <div class="h-full image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" :src="$f()[0].images[3]" />
                      </div>
                    </div>
                  </TinySlider>
                </div>
      ...
      <PreviewComponent class="intro-y box mt-5" v-slot="{ toggle }">
        ...
        <div class="p-5">
          <Preview>
            ...
            <div class="text-center">
              <a href="javascript:;" class="btn btn-primary mr-1 mb-2" @click="programmaticallyModal = true">Show
                Modal</a>
            </div>
            <!-- END: Show Modal Toggle -->
            <!-- BEGIN: Modal Content -->
            <Modal :show="programmaticallyModal" @hidden="programmaticallyModal = false">
              <ModalBody class="p-10 text-center">
                <!-- BEGIN: Hide Modal Toggle -->
                <a href="javascript:;" class="btn btn-primary mr-1" @click="programmaticallyModal = false">Hide
                  Modal</a>
                <!-- END: Hide Modal Toggle -->
                <!-- BEGIN: Toggle Modal Toggle -->
                <a href="javascript:;" class="btn btn-primary mr-1"
                  @click="programmaticallyModal = !programmaticallyModal">Toggle Modal</a>
