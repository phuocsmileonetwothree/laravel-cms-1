<template>
        ...
        <div class="flex mt-[4.7rem] md:mt-0">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li v-for="item in data" :key="item">
                                ...
                                <ul class="side-menu__sub-open" v-if="item.categories">
                                    <li v-for="item in item.categories" :key="item">
                                        <router-link :to="{ name: `cms.item.${generateSlug(item.title)}.index` }" class="side-menu">
                                            <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                            <div class="side-menu__title"> {{ item.title }} </div>
                                        </router-link>
                                    </li>
                    ...
                    <li>
                        <router-link :to="{ name: `cms.page.index` }" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                    ...
                    <li>
                        <router-link :to="{ name: `cms.design.index` }" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> Design </div>
                        </router-link>
                        <ul class="side-menu__sub-open">
  ...
  <script>
import { slugify } from "../helper/String";
export default {
    inject: ['baseURL'],
    name: 'App',
    data() {
    ...
    methods: {
        generateSlug(text) {
            console.log(text);
            return slugify(text); // Call slugify function and update slug
        },
        loadCategory() {
            let that = this;
            axios
