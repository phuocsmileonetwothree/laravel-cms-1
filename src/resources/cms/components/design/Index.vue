<template>
    <div class="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row mt-5">
        <div class="text-2xl font-medium group-[.mode--light]:text-white">Design</div>
        <div class="flex flex-col sm:flex-row gap-x-3 gap-y-2 md:ml-auto">
            <a :href="`${this.baseURL}/cms/design/create`"
                ...
                <table class="w-full text-left border-b border-slate-200/60">
                    ...
                    <thead v-if="data" ref="dataTable">
                        <tr v-for="item in data" :key="item">
                            ...
                            <td class="px-5 border-b dark:border-darkmode-300 py-4 border-dashed dark:bg-darkmode-600">
                                <a :href="baseURL + '/cms/design/edit/' + item.id" class="font-medium whitespace-nowrap">{{ item.title }}</a>
                            </td>
                            <td class="px-5 border-b dark:border-darkmode-300 py-4 border-dashed dark:bg-darkmode-600 w-[200px] overflow-hidden text-ellipsis">
                                <div class="whitespace-nowrap">{{ item.desc }}</div>
                            </td>
                            <td class="px-5 border-b dark:border-darkmode-300 py-4 border-dashed dark:bg-darkmode-600">
                                    ...
                                    <div class="relative h-5" >
                                        <Dropdown placement="bottom-end">
                                            ...
                                            <DropdownMenu class="w-40">
                                                <DropdownContent>
                                                    <DropdownItem>
                                                        <a :href="this.baseURL + '/cms/design/edit/' + item.id">Chỉnh sửa</a>
                                                    </DropdownItem>
...
export default {
    ...
    methods: {
        ...
        destroy(id) {
            axios.delete(`${this.baseURL}/cms/api/design/${id}`)
            .then((response) => {
